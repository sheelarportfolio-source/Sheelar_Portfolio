  ...
  <div style={{ marginBottom: '40px', paddingBottom: '20px', borderBottom: '1px solid var(--border-color)' }}>
    ...
    <ul style={listStyle}>
      {responsibilities.map((resp, index) => (
        <li key={index} style={listItemStyle}>{resp}</li>
      ))}
    </ul>
  </div>
);
...
export const currentExperienceDate = "JAN 2025 - PRESENT";

export const pastExperiencesData = [
  {
    date: "SEPTEMBER 2023 - AUGUST 2024",
    institution: "Alliance University, Dept of Computer Science & Engineering, Anekal",
    title: "Associate Professor & Course Co-ordinator(B-TECH)",
    responsibilities: [
  ...
  },
  {
    ...
    title: "Associate Professor & Academic Consultant, MILES EDUCATION",
    responsibilities: [
  ...
  },
  {
    ...
    responsibilities: [
      "Has been part of the Forensic Science Dept for handling both practical & theory in Cyber Forensics, Digital Forensics, Forensic Computing, and Cyber Security.",
    ...
    <div className="experience-section">
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', backgroundColor: 'var(--card-bg)', padding: '40px', borderRadius: '20px', border: '1px solid var(--border-color)' }}>
        ...
        <div style={{ marginBottom: '50px' }}>
          <p style={{ fontWeight: '700', color: 'var(--text-secondary)', fontSize: '14px', marginBottom: '10px' }}>{currentExperienceDate}</p>
        ...
        {showHistory && (
          <div style={{ animation: 'fadeIn 0.5s ease' }}>
            ...
            {pastExperiencesData.map((exp, index) => (
              <ExperienceItem
                key={index}
                date={exp.date}
